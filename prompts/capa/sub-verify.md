...
4. Report skipped checks and missing evidence. Static checks do not substitute for seam evidence; do not run a routine build. Do not write Engram or a session summary.
